...
# from algos.modules import DeepInversionFeatureHook
...
class FastMetaSynthesizer():
    def __init__(self, teacher, generator, normalizer, device, 
                 nz=256, num_classes=10, img_size=(3, 32, 32),
                 init_dataset=None, iterations=2, lr_g=5e-3,
                 synthesis_batch_size=256, sample_batch_size=256, 
                 adv=0.0, bn=10.0, oh=0.5,
                 save_dir='run/fast', transform=None, autocast=None, use_fp16=False,
                 distributed=False, lr_z = 0.015,
                 warmup=20, reset_l0=1, reset_bn=0, bn_mmt=0.9,
                 is_maml=1):
    ...
    def synthesize(self, targets=None):
        ...
        for it in range(self.iterations):
            ...
            loss = self.bn * loss_bn + self.oh * entropy + self.adv * loss_adv
