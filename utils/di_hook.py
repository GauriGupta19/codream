...
def get_weighted_bn_loss(hooks, weights):
    #TODO: with momentum, cuurently for bn_mmt=1/None
    loss_bn = 0
    print('running_var.data', hooks[0].module.running_var.data.shape)
    print('tmp_val[1]', hooks[0].tmp_val[1].shape)
    print('weights', weights.shape)

    for (idx, model) in enumerate(hooks):
