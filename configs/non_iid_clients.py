feddream_fast = {
    ...
    "algo": "feddream_fast",
    "exp_id": "distadam",
    "exp_type": "non_iid_balanced_labels_feddream_fast",
    "load_existing": False,
    "checkpoint_paths": {},
    "dset": "cifar10",
...
feddream_fast_noniid = {
    ...
    "global_steps": 1, "local_steps": 5, "nx_samples": 5, 
    # for local training
    "distill_batch_size": 256, "distill_epochs": 100, "dset_size": 5*256, 
...
fl = {
    "algo": "fedavg",
    "exp_id": 10,
    "exp_type": "non_iid_balanced_labels_fl",
    "dset": "cifar10",
    "dump_dir": "./expt_dump/cifar10/alpha_0.1/",
    "dpath": "./imgs/cifar10",
    "seed": 4,
    ...
    "device_ids": {"node_0": [3], "node_1": [3], "node_2": [6], "node_3": [6], "node_4": [7]},
...
isolated = {
    ...
    # server can have overlapping device ids with clients because
    # both are not used at the same time
    "device_ids": {"node_0": [1], "node_1": [1], "node_2": [2], "node_3": [2], "node_4": [0]},
